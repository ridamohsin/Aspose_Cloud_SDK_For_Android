 ...
 */
public class AllFormFieldsExceptDropDownExclusionStrategy implements ExclusionStrategy {
    ...
    public boolean shouldSkipField(FieldAttributes f) {
        ...
        return f.getName().equals("TextInputFormat") || f.getName().equals("TextInputType")
                ...
                || f.getName().equals("IsCheckBoxExactSize") || f.getName().equals("CheckBoxSize")
                || f.getName().equals("Checked");
    }
}
