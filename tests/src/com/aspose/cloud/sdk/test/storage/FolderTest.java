package com.aspose.cloud.sdk.test.storage;
...
import com.aspose.cloud.sdk.storage.DiscUsageModel;
import com.aspose.cloud.sdk.storage.FileExist;
import com.aspose.cloud.sdk.storage.FileModel;
...
public class FolderTest extends TestCase {
	...
	public void testGetFileAndSaveToDevice() throws Exception {
		InputStream fileStream = Folder.getFile("ScreenShot.png");
		assertNotNull("Failed to get file from Aspose server", fileStream);
		String filePath = Utils.saveStreamToFile(fileStream, "ScreenShot.png");
