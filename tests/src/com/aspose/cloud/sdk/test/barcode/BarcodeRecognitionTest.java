package com.aspose.cloud.sdk.test.barcode;

import java.util.ArrayList;

import com.aspose.cloud.sdk.barcode.BarcodeRecognition;
import com.aspose.cloud.sdk.barcode.BarcodeTypeEnum;
import com.aspose.cloud.sdk.barcode.EnableChecksumEnum;
import com.aspose.cloud.sdk.barcode.RecognitionResponse.RecognizedBarCode;
...
public class BarcodeRecognitionTest extends TestCase {
	...
	public void testReadBarcodeFromExternalImageURL() throws Exception {
		ArrayList<RecognizedBarCode> barcodes = BarcodeRecognition.readBarcodeFromExternalImageURL("http://bisqwit.iki.fi/barcode/t0/eEAN-13/s2.0/farial/a1/y80/x332960073452.png", BarcodeTypeEnum.AllSupportedTypes);
